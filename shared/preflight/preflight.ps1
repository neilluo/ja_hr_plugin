...
#   powershell -File shared\preflight\preflight.ps1                          # repo defaults
#   powershell -File shared\preflight\preflight.ps1 -Config C:\tmp\x.json    # missing config -> blocker=config
#   powershell -File shared\preflight\preflight.ps1 -Files nope.pdf          # missing file   -> blocker=files
